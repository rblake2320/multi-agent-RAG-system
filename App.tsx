...
const App: React.FC = () => {
  ...
  const handleSubmit = async (query: string) => {
    ...
    const updateStateCallback = (update: {
      stage: Stage;
      agent?: string;
      ...
      setProcessingState(prev => {
        ...
        return {
          ...
          response: update.response
            ? { ...(prev.response as AppResponse), ...update.response }
            : prev.response,
  ...
  const isLoading =
    processingState.stage !== Stage.Idle &&
    processingState.stage !== Stage.Complete &&
    processingState.stage !== Stage.Error;
